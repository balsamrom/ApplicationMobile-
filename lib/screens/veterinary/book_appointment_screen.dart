    ...
    if (widget.appointment != null) {
      ...
      _petsFuture.then((pets) {
        if (pets.isNotEmpty && mounted) {
          final petToSelect = pets.firstWhere(
          ...
          children: [
            Container(
              ...
              child: CircleAvatar(
                ...
                backgroundImage: widget.vet.photoPath != null &&
                    widget.vet.photoPath!.isNotEmpty
                    ? FileImage(File(widget.vet.photoPath!))
                    : null,
                child: (widget.vet.photoPath == null ||
                    widget.vet.photoPath!.isEmpty)
    ...
    return FutureBuilder<List<Pet>>(
      ...
      builder: (context, snapshot) {
        ...
        return DropdownButtonFormField<Pet>(
          ...
          validator: (value) =>
          value == null ? 'Veuillez sélectionner un animal' : null,
        );
      },
    );
  }
        ...
        Expanded(
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon:
              const Icon(Icons.access_time, color: accentOrange),
            ),
            readOnly: true,
            onTap: () async {
            ...
            validator: (value) =>
            value!.isEmpty ? 'Veuillez choisir une heure' : null,
          ),
        ),
      ],
    );
